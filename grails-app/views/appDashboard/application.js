...
(function() {
  ...
  Dashing.Outboard = (function(superClass) {
    extend(Outboard, superClass);

    function Outboard() {
      return Outboard.__super__.constructor.apply(this, arguments);
    }

    Outboard.prototype.ready = function() {};

    Outboard.prototype.onData = function(data) {};
