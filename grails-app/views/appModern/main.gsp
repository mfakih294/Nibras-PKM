...
%{--<script type="text/javascript" src="js/kickstart.js"></script>                                  <!-- KICKSTART -->--}%
	<link rel="stylesheet" href="${resource(dir: 'kickstart', file: 'style.css')}"/>
	<link rel="stylesheet" href="${resource(dir: 'kickstart/css', file: 'kickstart.css')}"/>
	<script type="text/javascript" src="${resource(dir: 'kickstart', file: 'jquery.min.js')}"></script>

	<script type="text/javascript" src="${resource(dir: 'kickstart/js', file: 'kickstart.js')}"></script>

</head><body>

<!-- Menu Horizontal -->
<ul class="menu">
<li class=""><a href="">Nibras PKM v1.6.0 </a></li>
<li class="current"><a href="">Calendar</a></li>
<li><a href="">Item 2</a></li>
<li><a href=""><span class="icon" data-icon="R"></span>Apps</a>
	<ul>
	<li><a href=""><i class="fa fa-car"></i> Calendar</a></li>
	<li><a href=""><i class="fa fa-arrow-circle-right"></i> Dashboard</a>
	<li><a href=""><i class="fa fa-arrow-circle-right"></i> Notes</a>
	<li><a href=""><i class="fa fa-arrow-circle-right"></i> Files</a>
	<li><a href=""><i class="fa fa-arrow-circle-right"></i> Courses</a>
		<ul>
