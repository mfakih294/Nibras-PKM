            ...
            <g:if test="${Course.countByBookmarked(true) > 0}">
                ...
                <g:each in="${mcs.Department.list([sort: 'code'])}" var="d">
                    ...
                    %{--<span style="padding: 1px;">--}%
                        ...
                        <tr>
                            <td colspan="3" style="text-align: center; background: #e0eee6; padding: 6px;margin-top: 6px;">
                                <a>
                       ...
                       %{--</h3>--}%
                        ...
                        <g:each in="${Course.findAllByDepartmentAndBookmarked(Department.get(d.id), true, [sort: 'code', order: 'asc'])}"
                            ...
                            <tr>
                                <td style="border-bottom: 1px dashed darkgray;  text-align: left">
                                    <i>${record.code ?: record.codeString}</i>
                                </td>
