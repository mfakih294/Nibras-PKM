...
%{--    <script type="text/javascript" src="${resource(dir: 'js', file: 'jquery.idletimer.js')}"></script>--}%
    ...
    <script type="text/javascript" src="${resource(dir: 'js', file: 'jquery.mjs.nestedSortable.js')}"></script>
...
<g:render template="/appCourse/regions" model="[htmlContent: htmlContent]"/>
