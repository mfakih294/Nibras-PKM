...
<head>
    ...
    <title style="direction: ltr; text-align: left;">${OperationController.getPath('app.name') ? OperationController.getPath('app.name') + ' /Mihrab': 'Nibras PKM /Mihrab'}
...
<g:render template="/appMihrab/regions" model="[htmlContent: htmlContent]"/>
