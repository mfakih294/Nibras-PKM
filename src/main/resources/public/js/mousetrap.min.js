...
(function (J, r, f) {
    ...
    function C(a, b, c, d, e, v) {
        ...
        for (g = 0; g < l[a].length; ++g)if (k =
                l[a][g], !(!d && k.seq && n[k.seq] != k.level || h != k.action || ("keypress" != h || c.metaKey || c.ctrlKey) && b.sort().join(",") !== k.modifiers.sort().join(","))) {
    ...
    function x(a, b, c) {
        m.stopCallback(b, b.target || b.srcElement, c) || !1 !== a(b, c) || (b.preventDefault && b.preventDefault(), b.stopPropagation && b.stopPropagation(),
    ...
    function E(a, b) {
        var c,
                d, e, f = [];
        c = "+" === a ? ["+"] : a.split("+");
        for (e = 0; e < c.length; ++e)d = c[e], G[d] && (d = G[d]), b && "keypress" != b && H[d] && (d = H[d], f.push("shift")), w(d) && f.push(d);
        c = d;
        e = b;
        if (!e) {
            if (!p) {
    ...
    function F(a, b, c, d, e) {
        ...
        a = a.replace(/\s+/g, " ");
        var f = a.split(" ");
        1 < f.length ? L(a, f, b, c) : (c = E(a, c), l[c.key] = l[c.key] || [], C(c.key, c.modifiers, {type: c.action},
                d, a, e), l[c.key][d ? "unshift" : "push"]({callback: b, modifiers: c.modifiers, action: c.action, seq: d, level: e, combo: a}))
    }
    ...
    var m = {bind: function (a, b, c) {
        ...
        unbind: function (a, b) {
            ...
            for (e = 0; e < d.length; ++e)d[e].seq ? d[e].level == f && (g = !0,
                    b[d[e].seq] = 1, x(d[e].callback, c, d[e].combo)) : g || x(d[e].callback, c, d[e].combo);
            d = "keypress" == c.type && I;
            c.type != u || w(a) || d || t(b);
            I = g && "keydown" == c.type
        }};
